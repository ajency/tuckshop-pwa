...
var HomePage = (function () {
    ...
    HomePage.prototype.updateSigninStatus = function (isSignedIn) {
        var _this = this;
        console.log(this);
        // this.zone.run(() => {});
        if (isSignedIn) {
...
HomePage = __decorate([
    ...
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-home',template:/*ion-inline-start:"/home/aj-sujit/new-tuck2/src/pages/home/home.html"*/'<!--<ion-header class= "bar bar-header bar-positive">\n\n<h1 align="center" >Search Google Spreadsheet</h1>\n\n</ion-header>\n-->\n\n<ion-header>\n	<ion-navbar align="center">\n		<ion-title>Tuckshop</ion-title>\n	</ion-navbar>\n</ion-header>\n\n\n<ion-content align = "center" padding>\n\n	<!-- <ion-list>\n\n\n\n	</ion-list> -->\n\n\n<!-- <div id="googleBtn">Google</div> -->\n\n	<ion-img width="400" height="400" src="/assets/img/tuckshop.jpg"></ion-img>\n	<div></div>\n\n	<h2 text-center class="welcome">\n		Grab some Tuck!\n	</h2>\n\n	<div padding>\n		<button  (click) = "handleClientLoad()" ion-button block  color="ajency" > Sign In </button>\n	</div>\n\n	<!-- <ion-row>\n		<button (click)="navigateToSearch()"ion-button block color="ajency">Sign In</button>\n	</ion-row> -->\n\n\n</ion-content>'/*ion-inline-end:"/home/aj-sujit/new-tuck2/src/pages/home/home.html"*/
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavController */], __WEBPACK_IMPORTED_MODULE_0__angular_core__["P" /* NgZone */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* ToastController */]])
], HomePage);
