...
BuyPage = __decorate([
    ...
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-buy',template:/*ion-inline-start:"/home/aj-sujit/new-tuck2/src/pages/buy/buy.html"*/'<ion-header>\n	<ion-navbar>\n		<ion-title>Are you sure you want to buy?</ion-title>\n	</ion-navbar>\n</ion-header>\n\n\n<ion-content padding>\n	<ion-list no-lines>\n		<ion-item no-padding>\n			<div item-left>\n				{{item.itemName}}\n			</div>\n			<div item-end>\n			  <small>Rs.</small>{{item.price}}\n			</div>\n		</ion-item>\n	</ion-list>\n	<p>\n		{{item.description}}\n	</p>\n</ion-content>\n\n<ion-footer>\n	<ion-toolbar>\n		<ion-buttons >\n			<button ion-button color="danger" (click)="dismiss()">\n				Cancel\n			</button>\n		</ion-buttons>\n		<ion-buttons end>\n			<button ion-button color="dark" (click) = "onBuy(item.itemCode)">\n				Buy\n			</button>\n		</ion-buttons>\n	</ion-toolbar>\n</ion-footer>'/*ion-inline-end:"/home/aj-sujit/new-tuck2/src/pages/buy/buy.html"*/,
    }),
